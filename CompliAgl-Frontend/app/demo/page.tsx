...
const SCENARIOS = {
  normal: {
    title: "Normal Action",
    description: "Good actor with small amount (≤250 USDC)",
    icon: Play,
    color: "green",
    intent: {
    ...
    expectedOutcome: "APPROVED → EXECUTED → coreActionCount=1",
  },
  oracle: {
    title: "Oracle Anomaly",
    description: "Amount exceeds max (>500 USDC)",
    icon: AlertTriangle,
    color: "red",
    intent: {
      actor_id: DEMO_ACTOR_ID,
    ...
    expectedOutcome: "DENIED → coreActionCount=0",
  },
  approval: {
    title: "Human Approval",
    description: "Amount requires escalation (250-500 USDC)",
    icon: UserCheck,
    color: "yellow",
    intent: {
      actor_id: DEMO_ACTOR_ID,
    ...
    expectedOutcome: "ESCALATED → coreActionCount=0",
  },
};
